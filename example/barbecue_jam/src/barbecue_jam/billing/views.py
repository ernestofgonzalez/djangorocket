...
from barbecue_jam.billing.forms import EditBillingInformationForm
from barbecue_jam.model_loaders import get_stripe_customer_model
...
def billing_settings_view(request):
    ...
    if request.method == "POST":
        if form.is_valid():
            ...
            return redirect("barbecue_jam-billing:billing-settings")
